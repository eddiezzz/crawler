...
class mysql():
    ...
    def clear_stats(self):
        if hasattr(self, 'where_sql'):
            delattr(self, 'where_sql')
        if hasattr(self, 'field_sql'):
            delattr(self, 'field_sql')
        if hasattr(self, 'order_sql'):
            delattr(self, 'order_sql')
        if hasattr(self, 'limit_sql'):
            delattr(self, 'limit_sql')
